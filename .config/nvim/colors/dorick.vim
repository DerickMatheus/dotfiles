" Vim color file - dorick
" Generated by http://bytefluent.com/vivify 2019-07-31
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi LineNr guifg=#6696e3 guibg=#2e2e2e guisp=#2e2e2e gui=NONE ctermfg=68 ctermbg=236 cterm=NONE
...
hi String guifg=#ff0000 guibg=#404040 guisp=#404040 gui=NONE ctermfg=196 ctermbg=238 cterm=NONE
